...
window.PORTFOLIO = {
  ...
  hero: {
    kicker: "AI CONTENT OPS · 2027",
    greeting: "你好，我是朱意",
    path: "实习路径：贝斯特斯新媒体 → 高顿用户运营 → 百度产品运营 → 字节 AI 内容运营 → 携程 AI 产品运营。",
    ...
    experienceCard: {
      ...
      items: [
        { company: "携程", role: "AI 产品运营" },
        { company: "字节", role: "AI 内容运营" },
  ...
  experience: {
    ...
    body: "我不是一开始就决定做产品，也不是天生就有产品 sense 的。我所经历的每一段实习都让我在试错中更加清晰自己的定位和职业规划：从新媒体运营、用户运营，到 AI 内容运营与产品运营，最后锚定内容增长与策略这条路。",
    stickyQuote:
    ...
    items: [
      ...
      },
      {
        ...
        role: "AI 产品运营",
        summary:
          "围绕【百度一镜】数字人平台有效线索转化，完成用户调研、需求优先级、内容种草与线索承接闭环，实现阅读率与线索增长。",
        metrics: [
      ...
      },
      {
        ...
        role: "AI 内容运营",
        summary:
          "因电商内容质量影响留存与 GMV，调研小红书标杆并制定种草视频标准，引入定制化 PE：维度拆解、评测集、CoT Prompt 与置信度分层，降低边界 case 回流人审。",
        metrics: [
          { value: "+15pp", label: "PE 准确率" },
          { value: "-16%", label: "人工成本" },
          { value: "+38pp", label: "标准一致率" },
        ],
        tags: ["优质分发", "标准基建", "PE 调优", "置信度分层", "AB 实验"],
        links: [],
      },
      {
        no: "06",
        ...
        role: "AI 产品运营",
        summary:
          "针对首页信息流低质内容，主导策略治理 L3：badcase 发现 → 相似召回 → 归因分流 → 策略制定 → 镜像 QA → 灰度上线；搭建 Evals，实现自动化打压策略与 AB 实验。",
        metrics: [
  ...
  vibe: {
    ...
    demos: [
      {
        title: "信息流治理 L2→L3",
        summary: "携程内容增长：A2A 编排与 Embedding 召回决策的端到端策略闭环",
        href: "#exp-06",
        tag: "CASE STUDY",
      },
      {
